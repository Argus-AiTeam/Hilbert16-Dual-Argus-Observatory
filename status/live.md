...
**Updated / 更新时间:** 2026-08-23 09:53:09 UTC

| Seat | State | Stage | Active role | Round | Current mission | Review | Since semantic progress |
|---|---|---|---|---:|---|---|---:|
| A | running | `solve` | reviewer | 1/32 | Certify the post-event266-top event266 bottom boundary | none | 3m |
| B | running | `solve` | engineer | 1/32 | Audit primary-source support for the calibrated target-section/global-h… | none | 0s |
