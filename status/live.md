...
**Updated / 更新时间:** 2026-08-13 13:05:35 UTC

| Seat | State | Stage | Active role | Round | Current mission | Review | Since semantic progress |
|---|---|---|---|---:|---|---|---:|
| A | running | `scope` | engineer | 1/32 | Independently derive or decisively narrow the \(I^1_{6b}\) center four-… | none | 34s |
| B | running | `scope` | engineer | 1/32 | Decide the corrected finite-Q HFC14 actual-remainder lemma after base-r… | none | 15s |
...
- **Mission:** Independently derive or decisively narrow the \(I^1_{6b}\) center four-type-II transition system
...
- **Git:** `d2524ec` · 69 changed path(s) · route: audit Roussarie cyclicity gap
...
- **Mission:** Decide the corrected finite-Q HFC14 actual-remainder lemma after base-resonance powers
- **Reviewer state:** `none`; rejected attempts: 0
...
- **Git:** `cfbe4c5` · 45 changed path(s) · math: record NEI14 exact-integral route
