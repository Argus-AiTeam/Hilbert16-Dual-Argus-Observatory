...
**Updated / 更新时间:** 2026-08-19 14:56:48 UTC

| Seat | State | Stage | Active role | Round | Current mission | Review | Since semantic progress |
|---|---|---|---|---:|---|---|---:|
| A | running | `solve` | reviewer | 1/32 | Review event519 top-exit certificate | none | 2s |
| B | running | `solve` | reviewer | 6/32 | Certify or refute the ERFZ14 derivative Binet scalar on the compact mid… | continue | 27s |
...
- **Mission:** Review event519 top-exit certificate
