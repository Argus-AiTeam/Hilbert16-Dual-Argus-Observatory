...
**Updated / 更新时间:** 2026-08-23 23:01:47 UTC

| Seat | State | Stage | Active role | Round | Current mission | Review | Since semantic progress |
|---|---|---|---|---:|---|---|---:|
| A | running | `solve` | engineer | 1/32 | Certify neg-zero:event480 top after event423 top | none | 1m |
| B | running | `solve` | engineer | 1/32 | Compute or obstruct the actual named-S2 T4/Z_p coupling | none | 26s |
...
- **Mission:** Certify neg-zero:event480 top after event423 top
...
- **Mission:** Compute or obstruct the actual named-S2 T4/Z_p coupling
- **Reviewer state:** `none`; rejected attempts: 0
