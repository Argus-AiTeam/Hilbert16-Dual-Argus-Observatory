...
**Updated / 更新时间:** 2026-08-14 12:28:25 UTC

| Seat | State | Stage | Active role | Round | Current mission | Review | Since semantic progress |
|---|---|---|---|---:|---|---|---:|
| A | running | `scope` | engineer | 32/32 | Decide the first concrete collar-normal-form attack on \(C^*_{n,a_*}\) | none | 29s |
| B | running | `scope` | engineer | 1/32 | Decide the all-order finite-Q boundary-layer principal germ behind the … | none | 31s |
...
- **Mission:** Decide the first concrete collar-normal-form attack on \(C^*_{n,a_*}\)
...
- **Git:** `a23cb52` · 1 changed path(s) · Checkpoint LRS n6 principal diagnostics
...
- **Mission:** Decide the all-order finite-Q boundary-layer principal germ behind the ERFZ14 composed coefficient obstructions
- **Reviewer state:** `none`; rejected attempts: 0
