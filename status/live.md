...
**Updated / 更新时间:** 2026-08-16 14:44:53 UTC

| Seat | State | Stage | Active role | Round | Current mission | Review | Since semantic progress |
|---|---|---|---|---:|---|---|---:|
| A | running | `scope` | engineer | 1/32 | Decide a positive-B-thickness lift of the row 22/31 fixed-B chamber | none | 1m |
| B | running | `scope` | engineer | 1/32 | Decide global separatrix attachment for the FQ2159 common-tuple product… | none | 42s |
