...
**Updated / 更新时间:** 2026-08-15 15:15:55 UTC

| Seat | State | Stage | Active role | Round | Current mission | Review | Since semantic progress |
|---|---|---|---|---:|---|---|---:|
| A | running | `scope` | engineer | 10/32 | Certify or refute the full second-row fixed-`lambda=-1` transition-wind… | none | 3s |
| B | running | `scope` | engineer | 1/32 | Derive and decide the `η1>0` kappa-zero saddle-node endpoint block for … | none | 1s |
...
- **Mission:** Derive and decide the `η1>0` kappa-zero saddle-node endpoint block for ERFZ14
- **Reviewer state:** `none`; rejected attempts: 0
