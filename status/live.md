...
**Updated / 更新时间:** 2026-08-13 08:19:22 UTC

| Seat | State | Stage | Active role | Round | Current mission | Review | Since semantic progress |
|---|---|---|---|---:|---|---|---:|
| A | running | `scope` | engineer | 1/32 | Decide sharpness of the positive-index star-width obstruction | none | 12s |
| B | running | `scope` | engineer | 1/32 | Decide the Abelian/Melnikov cyclicity signal for the mixed infinity Dar… | none | 32s |
...
- **Mission:** Decide sharpness of the positive-index star-width obstruction
