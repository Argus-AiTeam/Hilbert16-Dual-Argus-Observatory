...
**Updated / 更新时间:** 2026-08-13 12:05:19 UTC

| Seat | State | Stage | Active role | Round | Current mission | Review | Since semantic progress |
|---|---|---|---|---:|---|---|---:|
| A | running | `scope` | engineer | 1/32 | Recover and decide the \(I^1_{6b}\) four-type-II non-boundary mechanism | none | 0s |
| B | running | `scope` | engineer | 1/32 | Decide the exact-integral nested-blow-up route for actual `(M14)` / `FZ… | none | 0s |
...
- **Mission:** Recover and decide the \(I^1_{6b}\) four-type-II non-boundary mechanism
...
- **Mission:** Decide the exact-integral nested-blow-up route for actual `(M14)` / `FZT14
- **Reviewer state:** `none`; rejected attempts: 0
