...
**Updated / 更新时间:** 2026-08-14 12:13:22 UTC

| Seat | State | Stage | Active role | Round | Current mission | Review | Since semantic progress |
|---|---|---|---|---:|---|---|---:|
| A | running | `scope` | engineer | 30/32 | Decide the first concrete collar-normal-form attack on \(C^*_{n,a_*}\) | none | 10s |
| B | running | `scope` | engineer | 1/32 | Promote the ERFZ14 composed quadratic principal term and decide the pos… | none | 49s |
...
- **Git:** `3bdec14` · 26 changed path(s) · Retire full-triangle circuit chamber
...
- **Mission:** Promote the ERFZ14 composed quadratic principal term and decide the post-quadratic finite-Q remainder
- **Reviewer state:** `none`; rejected attempts: 0
