...
**Updated / 更新时间:** 2026-08-20 09:06:15 UTC

| Seat | State | Stage | Active role | Round | Current mission | Review | Since semantic progress |
|---|---|---|---|---:|---|---|---:|
| A | running | `solve` | reviewer | 1/32 | Decide the left frontier below lambda 2489/1000 | none | 2m |
| B | running | `solve` | planner | 1/32 | Principalize near-zero shifted-normal wall | done | 34s |
