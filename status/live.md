...
**Updated / 更新时间:** 2026-08-13 10:54:59 UTC

| Seat | State | Stage | Active role | Round | Current mission | Review | Since semantic progress |
|---|---|---|---|---:|---|---|---:|
| A | running | `scope` | engineer | 1/32 | Decide the LRS sparse-affine Harnack gap for fixed-degree star realizab… | none | 53s |
| B | running | `scope` | engineer | 1/32 | Attack the quadratic DRR boundary gap `(H^3_{14})` at theorem level | none | 9s |
...
- **Mission:** Decide the LRS sparse-affine Harnack gap for fixed-degree star realizability
...
- **Git:** `d2524ec` · 63 changed path(s) · route: audit Roussarie cyclicity gap
...
- **Mission:** Attack the quadratic DRR boundary gap `(H^3_{14})` at theorem level
- **Reviewer state:** `none`; rejected attempts: 0
