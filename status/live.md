...
**Updated / 更新时间:** 2026-08-16 10:28:57 UTC

| Seat | State | Stage | Active role | Round | Current mission | Review | Since semantic progress |
|---|---|---|---|---:|---|---|---:|
| A | running | `scope` | engineer | 5/32 | Decide the row `13_31` all-small-`B` obstruction `rank_15_key_3_minus | continue | 26s |
| B | running | `scope` | engineer | 1/32 | Extend or decisively obstruct the ERFZ14 product-one branch-split certi… | none | 54s |
...
- **Git:** `04ecfc0` · 1 changed path(s) · Certify row 13_31 rank18 small-u branch
...
- **Mission:** Extend or decisively obstruct the ERFZ14 product-one branch-split certificate on `chi_L in [2.50,2.52]
...
- **Git:** `2c56435` · 18 changed path(s) · Certify ERFZ14 product-one coverage through chi [1.40,2.50]
