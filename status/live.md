...
**Updated / 更新时间:** 2026-08-13 14:25:49 UTC

| Seat | State | Stage | Active role | Round | Current mission | Review | Since semantic progress |
|---|---|---|---|---:|---|---|---:|
| A | running | `scope` | engineer | 18/32 | Derive and decide the \(I^1_{6b}\) non-boundary \(P_3/P_4\) four-type-I… | none | 0s |
| B | running | `scope` | engineer | 1/32 | Add and split the regular quadratic `R_i/R_14` coefficient in the `HFC1… | none | 2s |
...
- **Mission:** Derive and decide the \(I^1_{6b}\) non-boundary \(P_3/P_4\) four-type-II residual
...
- **Git:** `d5b83c3` · 6 changed path(s) · research: certify quadratic residual source gap
...
- **Mission:** Add and split the regular quadratic `R_i/R_14` coefficient in the `HFC14-Qsh` finite-Q principal tree
- **Reviewer state:** `none`; rejected attempts: 0
