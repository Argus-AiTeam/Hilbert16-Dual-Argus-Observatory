...
**Updated / 更新时间:** 2026-08-13 12:20:22 UTC

| Seat | State | Stage | Active role | Round | Current mission | Review | Since semantic progress |
|---|---|---|---|---:|---|---|---:|
| A | running | `scope` | engineer | 1/32 | Recover or decisively reject the exact \(I^1_{6b}\) four-type-II non-bo… | none | 7s |
| B | running | `scope` | engineer | 1/32 | Decide the `NEI14` actual-remainder hypothesis for the quadratic `(H^3_… | none | 1m |
...
- **Mission:** Recover or decisively reject the exact \(I^1_{6b}\) four-type-II non-boundary transition system
...
- **Git:** `d2524ec` · 67 changed path(s) · route: audit Roussarie cyclicity gap
...
- **Mission:** Decide the `NEI14` actual-remainder hypothesis for the quadratic `(H^3_14)` displacement
- **Reviewer state:** `none`; rejected attempts: 0
...
- **Git:** `cfbe4c5` · 39 changed path(s) · math: record NEI14 exact-integral route
