...
**Updated / 更新时间:** 2026-08-14 12:03:20 UTC

| Seat | State | Stage | Active role | Round | Current mission | Review | Since semantic progress |
|---|---|---|---|---:|---|---|---:|
| A | running | `scope` | engineer | 28/32 | Decide the first concrete collar-normal-form attack on \(C^*_{n,a_*}\) | none | 13s |
| B | running | `scope` | engineer | 1/32 | Decide the actual finite-Q no-root composed-chain power-gain obstructio… | none | 19s |
...
- **Git:** `3bdec14` · 25 changed path(s) · Retire full-triangle circuit chamber
...
- **Mission:** Decide the actual finite-Q no-root composed-chain power-gain obstruction for ERFZ14
- **Reviewer state:** `none`; rejected attempts: 0
...
- **Git:** `6d1ac76` · 64 changed path(s) · math: record ERFZ14 trace Melnikov filter
