...
**Updated / 更新时间:** 2026-08-24 11:20:23 UTC

| Seat | State | Stage | Active role | Round | Current mission | Review | Since semantic progress |
|---|---|---|---|---:|---|---|---:|
| A | running | `solve` | engineer | 1/32 | Resolve the first far-negative endpoint collision | none | 5s |
| B | running | `solve` | reviewer | 1/32 | Compute the H313 finite-leg BVP principal coefficients | none | 0s |
...
- **Mission:** Compute the H313 finite-leg BVP principal coefficients
- **Reviewer state:** `none`; rejected attempts: 0
